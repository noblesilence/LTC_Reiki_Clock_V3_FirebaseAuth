...
package com.learnteachcenter.ltcreikiclock.application

import android.app.Application

import com.google.firebase.FirebaseApp
import com.learnteachcenter.ltcreikiclock.BuildConfig
import com.learnteachcenter.ltcreikiclock.di.*
...
class ReikiApplication : Application() {
    ...
    private fun initDagger(app: ReikiApplication): AppComponent =
            DaggerAppComponent
                    .builder()
