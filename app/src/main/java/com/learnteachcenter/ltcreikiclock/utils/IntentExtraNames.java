...
public class IntentExtraNames {
    ...
    public static final String EXTRA_POSITION_ID = "EXTRA_POSITION_ID";
    public static final String EXTRA_POSITION_SEQ_NO = "EXTRA_POSITION_SEQ_NO";
    public static final String EXTRA_POSITION_TITLE = "EXTRA_POSITION_TITLE";
    public static final String EXTRA_POSITION_DURATION = "EXTRA_POSITION_DURATION";
}
